              ...
              <div className="p-6">
                  ...
                  <p
                      ...
                      <Link href={`/posts_page`}>
                          <img className="max-w-[20rem] max-h-[20rem]" style={{borderRadius: "15px"}} src='https://sun9-1.userapi.com/impg/z0qxolF6x-NcVxZ_bFyZmFVt_iw0gQhrYohhGw/EmjyKnPAW-Y.jpg?size=736x808&quality=96&sign=af025c0e71634b65ee7caac2262b1f4d&type=album' alt='img'/>
                      </Link>
                  </p>
              </div>
          </div>
